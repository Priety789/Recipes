...
import { StyleSheet, Text, View, KeyboardAvoidingView, FlatList, Image, TextInput, TouchableOpacity, Alert } from 'react-native';
    ...
    render() {
        return (
            <KeyboardAvoidingView style={{ alignItems: 'center', marginTop: 20 }}>
                <View>
                    <Image
                        source={require("../assets/cartoon-child.jpg")}
